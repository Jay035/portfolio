...
export const Contact = () => {
  ...
  return (
    <main data-aos="fade-out" data-aos-duration="3000" className='relative bg-no-repeat bg-center bg-contact-Bg  bg-black-300 bg-blend-multiply bg-cover text-light-grey h-full overflow-x-hidden mt-[5.3rem]'>
      ...
      <div className={`${successTextState ? `flex` : `hidden` } transition-all text-xl font-semibold fixed top-8 right-3 flex-col bg-green-400/95 text-white gap-2 p-3 rounded-md w-3/4 max-w-md`}>
      ...
      <div className={`${errorTextState ? `flex` : `hidden`} transition-all text-xl font-semibold fixed top-8 right-3 flex-col bg-red-400/95 text-white gap-2 p-3 rounded-md w-3/4 max-w-md`}>
